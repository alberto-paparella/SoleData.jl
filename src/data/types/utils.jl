...
isincreasing(v::AbstractVector{<:Real}) = _check_trend(v, >)
isdecreasing(v::AbstractVector{<:Real}) = _check_trend(v, <)
isnonincreasing(v::AbstractVector{<:Real}) = _check_trend(v, <=)
isnondecreasing(v::AbstractVector{<:Real}) = _check_trend(v, >=)
